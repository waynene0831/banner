...
'use strict'; 
    ...
    Module.prototype.init = function () {    
          ...
          if ( this.option.transition ===true ) {
		   ...
		   //console.log(this);
		   //Module
		   //console.log(this.status[this.SetStatus]);
           // console.log(this.ele.status(this.SetStatus));
...
/////////////////////////////////////////////////////////////
       Module.prototype.toggle = function () {
		...
		this.$ele.removeClass( this.nowStatus(this.SetStatus) ).addClass( this.nowStatus(this.downStatus()) );
  		this.$ele.removeClass( this.nowStatus(this.SetStatus) ).addClass( this.nowStatus(this.downStatus()) );
		return this.SetStatus;
	     };

        Module.prototype.close = function () {
		this.$ele.removeClass( this.nowStatus(this.SetStatus) ).addClass( this.nowStatus(this.goStatus()) );
		this.$ele.removeClass( this.nowStatus(this.SetStatus) ).addClass( this.nowStatus(this.goStatus()) );
		return this.SetStatus;			
	     };


        Module.prototype.goStatus = function () {
        ...
        Module.prototype.downStatus = function () {
		if(this.SetStatus < this.status.lenght-1){
			this.SetStatus = 2;
		}
		this.SetStatus --;
